...
Você pode ajustar o comportamento da trait expondo um atributo ou sobrescrevendo um método:
...
class Ticket extends Model
{
    ...
    protected string $uuidColumn = 'uuid'; // preenche a coluna "uuid" em vez da chave primária

    protected function newUuid(): string
    {
        return 'custom-uuid'; // estratégia própria de geração
    }
}
```

Quando a coluna configurada for diferente da chave primária, o comportamento padrão de incremento do Eloquent permanece inalterado.
